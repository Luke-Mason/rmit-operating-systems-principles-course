...
int main(int argc, char *argv[]) {
   int unstable = 1;
   int result=0, length, status;
   int initTemp, uid, msqidC, msqid;
   	...
   	/*Create the mailbox for this process and store its IDs*/
   	msqid = msgget((CENTRAL_MAILBOX + uid), 0600 | IPC_CREAT);
